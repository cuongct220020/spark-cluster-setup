...
# Run this command and copy the output to replace SPARK_RPC_AUTHENTICATION_SECRET in your .env file
openssl rand -hex 32
```
...
## ⚠️ 11. Production Considerations
